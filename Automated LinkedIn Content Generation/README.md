...
2. **Connect your credentials**
   This file ships with placeholder-style credential references only — no secrets included. You'll need to create and attach your own credentials in n8n for:
